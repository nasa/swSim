/*! \headerfile DenseCellField.hpp "modules/Fields/include/DenseCellField.hpp"
* "DenseCellField.hpp" contains a concrete implementation of a dense cell field using the
...
#ifndef DENSECELLFIELD_HPP
#define DENSECELLFIELD_HPP
...
namespace Fields {
  /*! \class DenseCellField DenseCellField.hpp "imodules/Fields/include/DenseCellField.hpp"
  *
  ...
  *
  */
  class DenseCellField : public ModelUT::Field {
    public:
      /*!
      ...
      */
      void build(std::shared_ptr<ModelUT::Mesh> theMesh){
        field_data.clear();
        mymesh=theMesh;
        field_data.resize(mymesh->cellCount(),0.0);
      };
