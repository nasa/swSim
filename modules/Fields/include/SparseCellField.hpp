/*! \headerfile SparseCellField.hpp "modules/Fields/include/SparseCellField.hpp"
* "SparseCellField.hpp" contains a concrete implementation of a sparse cell field using the
...
#ifndef SPARSECELLFIELD_HPP
#define SPARSECELLFIELD_HPP
...
namespace Fields {
  /*! \class SparseCellField SparseCellField.hpp "imodules/Fields/include/SparseCellField.hpp"
  *
  * Is a concrete implementation of a sparse cell field. Provides the relevant functionality 
  * to appear as a general field as used in the rest of the code-base.
  *
  */
  class SparseCellField : public ModelUT::Field {
    public:
      /*!
      * Query the field for its type. Returns ModelUT::Field::CELL
      */
      ModelUT::Field::FieldType type() override {
        return ModelUT::Field::CELL;
      };
      /*!
      ...
      * \param nonzeroIndices is the list of populated cell indices
      */
